...
export const DEFAULT_FEATURES: Record<string, FeatureFlag> = {
  ...
  propuestas: {
    ...
    description: "Módulo de cotizaciones, presupuestos y pitches estratégicos.",
    category: "modulos",
    audience: "all",
    enabled: true,
  },
  ...
  diagramas: {
    id: "diagramas",
    label: "Diagramas & Arquitectura",
    description: "Centro de documentación visual interactiva y esquemas de arquitectura con diagram-design.",
    category: "herramientas",
    audience: "all",
    enabled: true,
  },
