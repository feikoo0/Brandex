...
void main() {
  ...
  // Soft edge fade so expanding rings dissolve smoothly before hitting canvas boundaries
  vec2 edgeDist = gl_FragCoord.xy / uResolution.xy;
  float edgeFadeX = smoothstep(0.0, 0.08, edgeDist.x) * smoothstep(1.0, 0.92, edgeDist.x);
  float edgeFadeY = smoothstep(0.0, 0.08, edgeDist.y) * smoothstep(1.0, 0.92, edgeDist.y);
