...
export const INITIAL_PROJECT_TASKS: Record<number, Task[]> = {
  1: [
    ...
    { 
      ...
      attachmentUrl: "/BRANDEX ICON.png",
      subtasks: [
...
export const INITIAL_PROJECTS: Project[] = [
  { id: 1, title: "Brandex OS Redesign", client: "Apple Inc.", package: "Premium", desc: "Implementación de interfaz espacial e iteración del motor de diseño con animaciones avanzadas en Next.js.", progress: "12 de 24 tareas", percent: "50%", gradient: "from-blue-600 to-cyan-400", glow: "bg-blue-600", status: "Revisión", statusColor: "bg-yellow-500/10 border-yellow-500/30 text-yellow-500", burnRate: "32h / 48h", deadline: "15 Ago", daysRemaining: "2 Días", briefCore: "Iteración completa del sistema operativo. Fokus en animaciones 60fps y glassmorphism avanzado.", priority: "Alta", cost: "$12,000", tasks: INITIAL_PROJECT_TASKS[1] },
