...
const RING = {
  idle: "focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:border-white/30",
  success: "",
  error: "ring-2 ring-[#FF3B30]/70 delay-150 border-rose-500/60",
} as const;
...
const SLOT_CLASS =
  "bg-[#222222] border border-white/10 text-center font-semibold text-transparent caret-transparent outline-none transition-all duration-200 selection:bg-transparent disabled:cursor-not-allowed disabled:opacity-50 hover:border-white/20 focus:bg-[#282828]";
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn("relative flex items-center justify-center", scale.gap)}
      >
        ...
        {caretVisible && (
          <motion.span
            ...
            className={cn(
              "pointer-events-none absolute left-0 top-1/2 w-0.5 rounded-full bg-white",
              scale.caret,
            )}
          />
        )}
