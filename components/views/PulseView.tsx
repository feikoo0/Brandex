...
export function PulseView() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex-shrink-0 px-5 pt-4 pb-2 flex flex-col overflow-hidden transition-all duration-500 ease-in-out"
        style={{ height: isTimelineCollapsed ? "100%" : "58%" }}
      >
        <div
      ...
      <div
        className={cn(
          ...
          isTimelineCollapsed ? "h-0 opacity-0 pointer-events-none py-0 border-t-0" : "h-[42%] opacity-100"
        )}
      >
